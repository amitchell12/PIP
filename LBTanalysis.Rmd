...
id_x <- nAudio10$jatosStudyResultId #identifying participants to be removed
# count void trials
...
bisect10Data <- filter(bisect10Data, !(jatosStudyResultId %in% id_x))
...
calibDat <- reshape2::melt(calibDat, value.name = 'RESP') #reshaping dataframe
