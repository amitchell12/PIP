...
tonic_diff <- summarySE(data = tonic_wide, measurevar = 'DIFF')
...
# saving
ggsave('TOT-plot.png', tonic_all, device = NULL, path = aPath,
       width = 9, height = 5, dpi = 600)
```
...
# now plot difference and put together!
# summary of difference
phasic_diff <- summarySE(data = phasic_wide, measurevar = 'DIFF')
