...
all_dat <- read.csv(file.path('data',fileName)) 
```
...
end_points_plot
# save
ggsave('end_points.png', end_points_plot, device = NULL, path = file.path('analysis'),
...
# save plot
ggsave('EWS_fig3.png', m_plot, device = NULL, path = file.path('analysis'),
...
block_test <- t.test(tonic_wide$DIFF, mu = 0, alternative = 'two.sided')
block_test
...
tone_test <- t.test(phasic_wide$DIFF, mu = 0, alternative = 'two.sided')
tone_test
...
ggsave('EWS_fig4.png', EWSplot, device = NULL, path = file.path('analysis'),
       width = 6, height = 8, dpi = 600)
ggsave('EWS_fig5.png', EWBplot, device = NULL, path = file.path('analysis'),
       width = 6, height = 8, dpi = 600)
```
...
# Extract means of EWS including all trials for manuscript
```{r}
...
# save
ggsave('EWS_fig6.png', explPlot, device = NULL, path = file.path('analysis'),
